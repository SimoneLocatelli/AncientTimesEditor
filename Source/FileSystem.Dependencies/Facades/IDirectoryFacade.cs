...
{
    /// <summary>
    ///     Facade class for the <see cref="System.IO.Directory" />
    /// </summary>
    [InheritedExport]
    public interface IDirectoryFacade
    {
        ...
        ///     error occurs when trying to determine if the specified file exists.true if <paramref name="fullPath" /> refers to
        ///     an existing directory; otherwise, false.
        /// </returns>
