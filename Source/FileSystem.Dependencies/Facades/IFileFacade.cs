...
{
    /// <summary>
    ///     Facade class for the <see cref="File" /> class from
    ///     the .Net Framework.
    /// </summary>
    [InheritedExport]
    public interface IFileFacade
    {
        ...
        ///     file; otherwise, false. This method also returns false if <paramref name="fullPath" /> is null, an invalid path, or
        ///     a
        ///     zero-length string. If the caller does not have sufficient permissions to read the specified file, no exception is
        ///     thrown and the method returns false regardless of the existence of <paramref name="fullPath" />.
        /// </returns>
